...
export const weatherCode: Map<number, string> = new Map([
    [0,'Clear sky'],
    [1,'Few clouds'],
    [2,'Scattered clouds'],
    [3,'Overcast'],
    ...
    [14,'Rain'],
    [15,'Rain showers'],
    [16,'Rain, thunderstorm'],
    [17,'Snow'],
    [18,'Snow showers'],
    [19,'Snow, thunderstorm'],
    [20,'Hail'],
    [21,'Hail showers'],
    [22,'Thunderstorm'],
    [23,'Squalls'],
...
export const countries: Map<string, ILocation> = new Map([
    ...
    ['Macedonia',{latitude:41.608635,longitude:21.745275}],
    ['Mali',{latitude:17.570692,longitude:-3.996166}],
    ['Myanmar',{latitude:21.913965,longitude:95.956223}],
